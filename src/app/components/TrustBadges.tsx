...
export const TrustBadges: React.FC = () => {
  ...
  return (
    <section className="py-10 sm:py-14 bg-[#0a0814] relative overflow-hidden cv-auto">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-emerald-900/[0.03] to-transparent" />
      ...
      <div className="w-full px-4 sm:px-6 max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
          {badges.map((badge, index) => (
            ...
            >
              <div className="mx-auto w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-emerald-600/20 to-emerald-800/10 flex items-center justify-center mb-3 group-hover:from-emerald-600/30 group-hover:to-emerald-800/20 transition-all duration-300">
                <badge.icon className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400" />
              </div>
