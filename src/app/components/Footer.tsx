...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#080614] border-t border-white/[0.04] relative">
      <div className="w-full px-4 sm:px-6 py-10 sm:py-14 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-9 h-9 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center">
                <span className="text-sm font-extrabold text-white">B</span>
              </div>
              <div>
                <h3 className="text-sm font-bold text-white leading-none">BILLIONS BET</h3>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {support.map((link, i) => (
                <li key={i}>
                  <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-xs text-gray-600 hover:text-emerald-400 transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-xs text-white placeholder-gray-600 focus:outline-none focus:border-emerald-500/30 transition-colors"
              />
              <motion.button
        ...
        <div className="border-t border-white/[0.04] pt-6">
          <div className="text-center space-y-2">
            <p className="text-[10px] sm:text-xs text-emerald-500/60 font-medium">
              {t('responsibleGaming')}
            </p>
